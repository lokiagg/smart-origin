...
#define CPU_PHYSICAL_CORE_NUM 24  // [CONFIG]
...
// app thread
#define MAX_APP_THREAD 36    // one additional thread for data statistics(main thread)  [config]
...
// Remote Allocation
constexpr uint64_t dsmSize           = 32;        // GB  [CONFIG]
